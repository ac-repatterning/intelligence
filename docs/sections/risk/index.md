...
??? note "Extra Notes"
    ...
    Per gauge station series, weighted-rate-of-change values are calculated for contiguous 1-hour-blocks across a specified time span; currently $\approx 9$ days.  During a 9-day time span there are approximately<br><br>
